...
| `GET /app[/…]` | Session cookie, or an operator token entered on the sign-in page | The new web app (preview): sign-in, console shell and the standups list; the remaining screens land release by release while `/dashboard` stays |
